...
interface StartMenuProps {
  ...
  onClose: () => void;
  className?: string;
  currentType?: 'topicalKeyword' | 'offer' | 'event';
}

const TopReplace: React.FC<StartMenuProps> = ({ isOpen, onSelect, onClose, className, currentType }) => {
  ...
  // Get available options based on current type
  ...
  return (
    <div
      ...
      style={{
        ...
        marginTop: -4,
        width: '194.762px',
        height: '76px' // Reduced height for 2 options
      }}
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="194.762" height="76" viewBox="0 0 194.762 76">
        <defs>
          ...
          <filter id="Op_component_2" x="4.966" y="0" width="189.796" height="76" filterUnits="userSpaceOnUse">
            <feOffset dy="2" in="SourceAlpha"/>
        ...
        {/* Correct Arrow shape from StartMenu, behind background, centered vertically */}
        <g id="Op_component_1-2" data-name="Op component 1" transform="translate(-809.69 -225.69)" fill="#fff">
        ...
        {/* Menu background and border, above the arrow */}
            ...
            {type === 'topicalKeyword' && (
              <g transform={`translate(24, ${12 + (index * 36)})`}>
                <g id="Group_3331" data-name="Group 3331" transform="translate(0, 0)">
                  ...
                  <path id="Path_408" data-name="Path 408" d="M.552,0,2.6.027a.552.552,0,0,1,.552.552l-.416,3.4a.552.552,0,0,1-.552.552L.914,4.554A.552.552,0,0,1,.362,4L0,.552A.552.552,0,0,1,.552,0Z" transform="translate(13.043 14.226) rotate(-49)" stroke="rgba(0,0,0,0)" strokeMiterlimit="10" strokeWidth="1" fill="url(#linear-gradient)"/>
                </g>
              </g>
            )}
            {type === 'offer' && (
              <g id="lineicons_offer" transform={`translate(24, ${12 + (index * 34)}) scale(1)`}>
