  ...
  return (
    <div className={`${animationClass} relative`}>
      ...
      >
        ...
        <div
          className={`video-node-connector-left absolute left-[-16.5px] top-[50%] transform -translate-y-1/2 pointer-events-none z-20 ${data.isLeftConnected ? 'is-connected' : ''}`}>
          <svg width="17" height="25" viewBox="0 0 17 25">
      ...
      <div className="absolute w-full text-center" style={{ top: 'calc(100% + 10px)' }}>
        <NodeTimer
          ...
          color="#3799db"
          nodeName="Video"
          gradientId="video-node-gradient"
        />
      </div>
    </div>
  );
